...
function NavigationLinks({ links }: { links: NavigationLink[] }) {
    return (
        <>
            {links.map((link) => (
                <li key={link.href}>
...
// External links component for reusability
...
export default function Navbar() {
    ...
    const externalLabel = isEnglish ? "External" : "外部リンク";
            ...
            <div className="navbar-start">
                ...
                <div className="dropdown">
                    ...
                    >
                        ...
                        <div className='mt-2'>
                            <summary>{externalLabel}</summary>
                            <ul className="p-2 w-auto min-w-max">
                                <ExternalLinksMenu links={externalLinks} label={externalLabel} />
                            </ul>
                        </div>
                    </ul>
                </div>
